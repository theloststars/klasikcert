                ...
                <ul class="navbar-nav header-right">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="media mr-2">
                                                <img alt="image" width="50"
                                                    src="{{ asset('acaraAdminPanel/xhtml/images/avatar/1.jpg') }}">
                                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            <img src="{{ Auth::user()->image ? asset('storage/photoProfiles/' . Auth::user()->image) : asset('acaraAdminPanel/xhtml/images/profile/17.jpg') }}"
                                width="20" alt="">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ route('account.index') }}" class="dropdown-item ai-icon">
