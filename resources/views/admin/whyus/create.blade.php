    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.whyus.index') }}">Why Us Content</a></li>
                        ...
                        <form action="{{ route('admin.whyus.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="shortdescription" name="short_description"
                                    placeholder="short description" style="color: #656773;" value="{{ old('short_description') }}" required>
