...
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="card-title">
                            <a class="add-menu-sidebar" href="{{ route('admin.permissions.create') }}">Create New</a>
                        </h4>
                    </div>
                    <div class="card-body">
    ...
    <form action="{{ route('admin.permissions.bulkDelete') }}" id="deleteSelectedForm" method="POST" class="d-none">
        @csrf
        @method('DELETE')
