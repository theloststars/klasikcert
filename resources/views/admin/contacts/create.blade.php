    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.contacts.index') }}">contact Menu</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.contacts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="url_slug" class="text-capitalize">url-slug</label>
                                <input type="text" class="form-control" id="url_slug" name="url_slug"
                                placeholder="URL SLUG must be filled like this: phone-number, address, office-email, etc" style="color: #656773;" value="{{ old('title') }}" required>
                                @error('url-slug')
                                    <div class="text-sm text-danger">{{ $message ?? 'Something error' }}</div>
                                @enderror
                            </div>
