...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Abouts</a></li>
            </ol>
        </div>
        <!-- row -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="card-title">
                            <a class="add-menu-sidebar" href="{{ route('admin.abouts.create') }}">Create New</a>
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="datatable" class="display min-w850">
                                ...
                                <tbody>
                                    @foreach ($abouts as $about)
                                        <tr data-identifier="{{ $about->id }}">
                                            <td></td>
                                            <td>{{ $about->title }}</td>
                                            <td>
                                                <img src="{{ Storage::disk('public')->url($about->thumbnail) }}"
                                            ...
                                            <form action="{{ route('admin.abouts.destroy', $about->id) }}"
                                                method="post" id="destroy-{{ $about->id }}" style="display: none">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </tr>
    ...
    <form action="{{ route('admin.abouts.bulkDelete') }}" id="deleteSelectedForm" method="POST" class="d-none">
        @csrf
        @method('DELETE')
