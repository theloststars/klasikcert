                        ...
                        <form action="{{ route('admin.abouts.update', $about->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="Title"
                                    style="color: #656773;" value="{{ $about->title }}" required>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description" id="short_description" rows="10" class="form-control">{!! $about->short_description !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="body" rows="10" class="form-control">{!! $about->description !!}</textarea>
                                @error('description')
                                    <div class="text-sm text-danger">{{ $message ?? 'Something error' }}</div>
                                @enderror
                            </div>
