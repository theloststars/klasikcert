            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="card-title">
                            <a class="add-menu-sidebar href="{{ route('admin.roles.create') }}">Create New</a>
                        </h4>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr data-identifier="{{ $role->id }}">
                                            ...
                                            <td>
                                                @if ($role->name == 'super admin')
                                                    <span class="badge badge-xs badge-success text-bold">ALL ACCESS</span>
                                                @else
                                                    @foreach ($role->permissions as $permission)
                                                        <span
                                                            class="badge badge-xs badge-info">{{ $permission->name }}</span>
                                                    @endforeach
                                                @endif
                                            </td>
