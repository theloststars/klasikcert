...
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="card-title">
                            <a class="add-menu-sidebar" href="{{ route('admin.services.create') }}">Create New</a>
                        </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($services as $service)
                                        <tr data-identifier="{{ $service->id }}">
                                            ...
                                            <form action="{{ route('admin.services.destroy', $service->id) }}"
                                                method="post" id="destroy-{{ $service->id }}" style="display: none">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </tr>
    ...
    <form action="{{ route('admin.services.bulkDelete') }}" id="deleteSelectedForm" method="POST" class="d-none">
        @csrf
        @method('DELETE')
