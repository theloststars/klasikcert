                    ...
                    <div class="col-xl-12 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body pb-0 dz-scroll height630 loadmore-content" id="latestSalesContent">
                                <div class="pb-3 mb-3 border-bottom">
                                    ...
                                    <div class="d-flex align-items-end">
                                        <img src="{{ asset('acaraAdminPanel/xhtml/images/profile/20.jpg') }}"
                                            alt="" width="42" class="rounded-circle mr-2">
                                        <div class="mr-auto">
                                            <h4 class="fs-14 mb-0"><a href="app-profile.html" class="text-black">Steffany
                                                    Humble</a></h4>
                                ...
                                <div class="pb-3 mb-3 border-bottom">
                                    <p class="font-w600"><a href="event.html" class="text-black">Envato Author SF
                                            Meetup</a></p>
                                    <div class="d-flex align-items-end">
                                        <img src="{{ asset('acaraAdminPanel/xhtml/images/profile/21.jpg') }}"
                                            alt="" width="42" class="rounded-circle mr-2">
                                        <div class="mr-auto">
                                            <h4 class="fs-14 mb-0"><a href="page-error-404.html" class="text-black">Jacob
                                                    Swing Swing</a></h4>
                                ...
                                <div class="pb-3 mb-3 border-bottom">
                                    ...
                                    <div class="d-flex align-items-end">
                                        <img src="{{ asset('acaraAdminPanel/xhtml/images/profile/22.jpg') }}"
                                            alt="" width="42" class="rounded-circle mr-2">
                                        <div class="mr-auto">
                                            <h4 class="fs-14 mb-0"><a href="page-error-404.html"
                                ...
                                <div class="pb-3 mb-3 border-bottom">
                                    <p class="font-w600"><a href="event.html" class="text-black">Indonesia Envato
                                            Authors National Meetup</a></p>
                                    <div class="d-flex align-items-end">
                                        <img src="{{ asset('acaraAdminPanel/xhtml/images/profile/23.jpg') }}"
                                            alt="" width="42" class="rounded-circle mr-2">
                                        <div class="mr-auto">
                                            <h4 class="fs-14 mb-0"><a href="page-error-404.html" class="text-black">Kevin
                                                    Stefanus</a></h4>
                                            <span class="fs-12">2m ago</span>
                                        </div>
                                        <span class="badge badge-sm light badge-primary">1 Ticket</span>
                            ...
                            <div class="card-footer text-center border-0">
                                <a class="btn btn-primary btn-sm dz-load-more" id="latestSales" href="javascript:void(0)"
                                    rel="ajax/latest-sales.html">View More</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="event-bx owl-carousel">
                                    <div class="items">
                                        <div class="image-bx">
                                            <img src="{{ asset('acaraAdminPanel/xhtml/images/events/1.png') }}"
                                                alt="">
                                            <div class="info">
                                                ...
                                                <p class="fs-12">Lorem ipsum dolor sit amet, consectetur
                                                    ...
                                                    magna aliqua. Ut enim ad mini</p>
                                                <ul>
                                    ...
                                    <div class="items">
                                        <div class="image-bx">
                                            <img src="{{ asset('acaraAdminPanel/xhtml/images/events/3.png') }}"
                                                alt="">
                                            <div class="info">
                                                <p class="fs-18 font-w600"><a href="event-detail.html"
                                    ...
                                    <div class="items">
                                        <div class="image-bx">
                                            <img src="{{ asset('acaraAdminPanel/xhtml/images/events/2.png') }}"
                                                alt="">
                                            <div class="info">
                                                <p class="fs-18 font-w600"><a href="event-detail.html"
                                                        class="text-black">Envato Indonesian Authors Meetup 2020</a>
                                                </p>
