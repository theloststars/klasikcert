...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Footer Logo</a></li>
            </ol>
        </div>
        <!-- row -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="card-title">
                            <a class="add-menu-sidebar" href="{{ route('admin.footerlogos.create') }}">Create New</a>
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="datatable" class="display min-w850">
                                ...
                                <tbody>
                                    @foreach ($footerlogos as $footerlogo)
                                        <tr data-identifier="{{ $footerlogo->id }}">
                                            <td></td>
                                            <td>{{ $footerlogo->title }}</td>
                                            <td>
                                                <img src="{{ Storage::disk('public')->url($footerlogo->thumbnail) }}"
                                            ...
                                            <td>
                                                <div class="d-flex flex-column flex-md-row justify-content-center"
                                                    style="gap: 0.5rem">
                                                    @can('services update')
                                                        <a href="{{ route('admin.footerlogos.edit', $footerlogo->id) }}"
                                            ...
                                            <form action="{{ route('admin.footerlogos.destroy', $footerlogo->id) }}"
                                                method="post" id="destroy-{{ $footerlogo->id }}" style="display: none">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </tr>
    ...
    <form action="{{ route('admin.footerlogos.bulkDelete') }}" id="deleteSelectedForm" method="POST" class="d-none">
        @csrf
        @method('DELETE')
