    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.footerlogos.index') }}">Footer Logos</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.footerlogos.update', $footerlogo->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="Title"
                                    style="color: #656773;" value="{{ $footerlogo->title }}" required>
                                @error('title')
