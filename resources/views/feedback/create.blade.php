                        ...
                        <form action="{{ route('admin.feedback.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Client Name" style="color: #656773;" required>
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="position" name="position"
                                    placeholder="Client position" style="color: #656773;" required>
                                @error('position')
                                    <div class="text-sm text-danger">{{ $message ?? 'Something error' }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="customFIle" class="text-capitalize">Photo</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="feedback" id="feedback" rows="10" class="form-control" required style="color: #656773;">{!! @$blog->feedback ?? 'Feedback' !!}</textarea>
                                @error('feedback')
                                    <div class="text-sm text-danger">{{ $message ?? 'Something error' }}</div>
                                @enderror
                            </div>
